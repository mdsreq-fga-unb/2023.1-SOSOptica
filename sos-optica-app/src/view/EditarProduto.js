...
class CadastroProduto extends React.Component{
    ...
    componentDidMount() {
        ...
        if (params.id){
            this.clienteService.getProdutoById(params.id).then(response => {
    ...
    editar = () =>{
        ...
        this.produtoService.atualizar(id, dadosProduto).then(response => {
            mensagemSucesso(`Produto <b>${response.data.nomeProduto}</b> atualizado com sucesso!`)
            this.cancelar()
        }).catch(error => {
                mensagemErro(error.response.data)
        });
    ...
    render() {
        ...
        return (
            <>
                <Dashboard></Dashboard>
                <Card title="Editar Produto"  icon="bx bxs-package">
